...
export default function DeliveryTypeSelector({ deliveryType, onChange, labels }: Props) {
  return (
    <div>
      <label className="block text-sm font-medium text-gray-700 mb-2">{labels.deliveryType}</label>
