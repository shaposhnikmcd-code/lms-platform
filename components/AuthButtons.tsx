                ...
                <>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                    <button
                      ...
                      disabled={loading}
                      className="w-full flex items-center justify-center gap-3 bg-white border border-[#dadce0] hover:bg-[#f8f9fa] text-[#3c4043] font-medium py-3 px-4 rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
