...
const certs = [
  {
    ...
    preview: '/yearly-program/vision_cert-1.png',
  ...
  },
  {
    ...
    preview: '/yearly-program/uimp_cert-1.png',
    title: 'UIMP',
      ...
      {mounted && active && createPortal(
        ...
        >
          <div
            ...
            style={{ width: '90vw', maxWidth: '860px', borderRadius: '1rem', overflow: 'hidden', boxShadow: '0 25px 60px rgba(0,0,0,0.5)', background: '#1C3A2E', display: 'flex', flexDirection: 'column' }}
          >
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0.875rem 1.5rem', borderBottom: '1px solid rgba(212,168,67,0.2)', flexShrink: 0 }}>
              ...
              <button
                onClick={close}
                style={{ width: '2rem', height: '2rem', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(255,255,255,0.1)', border: 'none', cursor: 'pointer', color: 'white' }}
              >
                <FaTimes />
              </button>
            </div>
            <div style={{ position: 'relative', width: '100%', maxHeight: '80vh', overflow: 'auto', background: '#fff' }}>
              <img
                src={active.preview}
                alt={active.title}
