  ...
  return (
    <>
      <section
        className="py-12"
        style={{
          background: 'linear-gradient(to bottom, #ffffff 0%, rgba(255,255,255,0) 18%, rgba(255,255,255,0) 82%, #ffffff 100%), radial-gradient(ellipse 90% 90% at center, #E8DBBC 0%, #F0E6CF 20%, #FAF6F0 50%, #ffffff 100%)',
        }}
      >
