export default function PricingSection() {
  ...
  const h2Style: React.CSSProperties = { fontFamily: 'Georgia, serif', fontSize: 'clamp(24px, 3vw, 36px)', fontWeight: 400, color: '#1C3A2E', margin: 0, letterSpacing: '-0.02em' };
  ...
  const h3Style: React.CSSProperties = { fontFamily: 'Georgia, serif', fontSize: '18px', fontWeight: 400, color: '#1C3A2E', margin: '0 0 10px' };
  const pStyle: React.CSSProperties = { fontSize: '13px', color: 'rgba(0,0,0,0.4)', lineHeight: 1.75, margin: '0 0 20px', fontFamily: '-apple-system, sans-serif' };
  const dividerStyle: React.CSSProperties = { height: '1px', background: '#f0f0f0', marginBottom: '20px' };
  const btnStyle: React.CSSProperties = { display: 'block', background: '#1C3A2E', color: 'white', fontWeight: 700, padding: '12px 24px', borderRadius: '12px', textAlign: 'center', fontSize: '12px', letterSpacing: '0.06em', textTransform: 'uppercase', textDecoration: 'none', fontFamily: '-apple-system, sans-serif' };
