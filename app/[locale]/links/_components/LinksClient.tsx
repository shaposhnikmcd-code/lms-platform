            ...
            <div className="absolute top-20 right-6 bg-white p-4 rounded-lg text-center z-10 shadow-xl w-48">
              ...
              <div className="flex justify-center mb-3">
                <div className="w-32 h-32 bg-gray-200 flex items-center justify-center rounded-lg">
                  <span className="text-gray-500 text-xs">{content.qrTitle}</span>
                </div>
              </div>
              <button onClick={() => setShowQR(false)} className="text-[#003d30] underline text-xs">
                {content.qrClose}
              </button>
            </div>
          )}
          ...
          <div className="flex flex-col items-center justify-center mt-4">
            <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center mb-6 shadow-lg overflow-hidden">
              <div className="relative w-16 h-16">
                <Image src="/logo-white.webp" alt="UIMP" fill className="object-contain" />
              </div>
            </div>
