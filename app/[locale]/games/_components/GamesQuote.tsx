...
const quoteCardStyle: React.CSSProperties = {
  maxWidth: '720px',
  margin: '0 auto',
  background: 'linear-gradient(135deg, #0c1f16 0%, #1C3A2E 100%)',
  borderRadius: '24px',
  padding: '1.5rem 3rem 2rem',
  position: 'relative' as const,
  overflow: 'hidden' as const,
  boxShadow: '0 20px 60px rgba(28,58,46,0.18), 0 4px 20px rgba(28,58,46,0.1)',
};

const decorTopStyle: React.CSSProperties = {
...
const decorBottomStyle: React.CSSProperties = {
  position: 'absolute' as const,
  bottom: '-60px',
  left: '-60px',
  width: '220px',
...
const openingMarkStyle: React.CSSProperties = {
...
const dividerStyle: React.CSSProperties = {
  width: '2.5rem',
  height: '2px',
  background: 'linear-gradient(to right, #D4A843, rgba(212,168,67,0.3))',
...
const comingSoonSectionStyle: React.CSSProperties = {
  background: '#FAF6F0',
  borderTop: '1px solid rgba(28,58,46,0.08)',
  padding: '2.5rem 2rem',
