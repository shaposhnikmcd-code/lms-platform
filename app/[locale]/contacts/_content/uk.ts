export const contactsContent = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Що буде якщо на картці не вистачить коштів?", a: "Якщо чергове списання не пройшло (нема коштів, банк відхилив, картка скасована) — ми одразу надішлемо лист з посиланням на оплату вручну. Доступ до програми ще певний час зберігається — точну дату закриття ви побачите в листі. Якщо до неї проблема не вирішена, доступ закривається. WayForPay може повторити спробу автоматично протягом цього періоду." },
