...
export default async function BiblicalHeroesPricing({ locale, price, oldPrice }: { locale: string; price: number; oldPrice: number | null }) {
          ...
          <div className="relative px-6 py-8 md:px-10 grid md:grid-cols-[1fr_auto] gap-8 md:gap-10 items-center">
            ...
            <div className="flex flex-col items-center gap-3 mx-auto">
              <div className="bg-white rounded-xl p-3 shadow-lg ring-1 ring-[#D4A017]/30">
                <Image src="/courses/psychotherapy-of-biblical-heroes/qr.png" alt="QR" width={150} height={150} className="block" />
              </div>
