      ...
      <div className="flex items-center gap-2 flex-wrap">
        <div className="flex items-center gap-1.5">
          ...
          <HoverInfo
            ...
            body={
              cohort.launchedAt
                ? `Запущено: ${new Date(cohort.launchedAt).toLocaleString('uk-UA')}\nПовторно запустити не можна.\n\nЩО ЗАРАЗ ВІДБУВАЄТЬСЯ:\n• Усім, хто вже оплатив, доступ відкрито + надіслано лист з логіном.\n• Нові оплати ПРИЙМАЮТЬСЯ (поки увімкнено «Реєстрація відкрита») і КОЖНА одразу відкриває доступ у SendPulse + шле лист з логіном і Telegram — автоматично, без твоєї участі. Черги до старту немає.\n• Дата старту НЕ керує продажем — продаж триває до кінця cohort-у або поки не вимкнеш тумблер.\n\nЗупинити продаж = вимкнути «Реєстрація відкрита».\nДослати welcome-лист тим, кому не дійшло → кнопка "✉️ Дослати лист" поряд.`
                : cohort.launchScheduledFor
                  ...
                  : `ЕТАПИ — що станеться:\n\n1) ЗАРАЗ, ДО запуску:\n• Продаж на сайті активний, поки увімкнено «Реєстрація відкрита».\n• Покупець отримує лише welcome-лист БЕЗ логіну. Доступ до платформи ще закритий — оплата зібрана, людина чекає старту.\n\n2) У МОМЕНТ запуску (ця кнопка):\n🔓 Відкриває доступ у SendPulse усім, хто вже оплатив.\n✉️ Шле лист «програма стартувала» з логіном + Telegram-запрошення.\n📅 Фіксує дату запуску і рахує «Доступ до».\n(Два режими: запустити одразу або запланувати на дату.)\n\n3) ПІСЛЯ запуску (нові покупці):\n• Сайт НЕ закриває продаж сам — керує тумблер «Реєстрація відкрита».\n• Кожна нова оплата → доступ ВІДКРИВАЄТЬСЯ ОДРАЗУ + лист з логіном, автоматично. Черги до старту немає.\n\n4) Дата старту (напр. 01.09) = сітка модулів:\n• Продажем НЕ керує і нічого не закриває в день старту.\n• Задає сітку: набір = 9 модулів по календарному місяцю від дати старту (вересень = модуль 1 … травень = модуль 9).\n• Річний → доступ до кінця cohort-у.\n• Місячний: оплата ВСЕРЕДИНІ модуля покриває цей модуль повністю, незалежно від дня. Наступні оплати/списання — у ПЕРШИЙ ДЕНЬ наступних модулів (те саме число, що й дата старту набору), однаково у всіх.\n• Пізній покупець просто починає з пізнішого модуля і має менше слотів: купив у жовтні → модуль 2, 8 платежів замість 9.\n\nЗакрити продаж = вручну вимкнути «Реєстрація відкрита».`
            }
          />
