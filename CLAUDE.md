...
Симетрична таблиця між `/dashboard/admin/payments` (Тип / Покупка-Підписка) і `/dashboard/admin/payment-logs` (Тип / Вид). Назви мають збігатись у обох views.

| Продукт | Тип | Вид/Покупка |
|---|---|---|
