...
/// Якір рядка «Уже навчаєтесь за місячною оплатою? Оплатити наступний модуль» під
/// карткою «Щомісячна оплата». Туди веде кнопка з блоку «Посилання недійсне»: це єдиний
/// шлях оплатити модуль без персонального посилання, який працює і при закритій
/// реєстрації (картки тарифів тоді неактивні).
export const RENEW_ENTRY_ANCHOR = 'renew-module';
