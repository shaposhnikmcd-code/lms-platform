...
export function certificateEmailHtml(args: CertificateEmailArgs): string {
  ...
  if (args.type === 'COURSE') {
    ...
    achievement = 'Ви прослухали повний курс Річної програми в Українському інституті душеопіки та психотерапії та отримуєте сертифікат у категорії <strong>Слухач</strong>.';
  } else if (args.category === 'PARTICIPANT') {
    achievement = 'Ви були учасником Річної програми в Українському інституті душеопіки та психотерапії та отримуєте сертифікат у категорії <strong>Учасник</strong>.';
  } else {
    achievement = 'Ви успішно завершили Річну програму в Українському інституті душеопіки та психотерапії та отримуєте сертифікат у категорії <strong>Практична участь</strong>.';
  }
